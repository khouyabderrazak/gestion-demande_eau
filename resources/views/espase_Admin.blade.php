...
<nav class="navbar  nv1 navbar-expand-lg">
  ...
  <nav class="navbar navbar-expand-lg nv2 sticky-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="{{ url('espase_Admin/ar') }}"><button type="button" class="btn bt ar me-2 " >{{ __('index.20') }}</button></a>
        <a href="{{ url('espase_Admin/fr') }}"><button type="button" class="btn bt fr ">{{ __('index.21') }}</button></a>
      </div>
    </div>
  </nav>
  @endif
  ...
  @endif
	...
	<div class="form text-center" style="max-width: 50rem;margin:auto;">
		<img src="../Admin.jpeg">
		<form action="{{ config('app.locale') == 'fr' ? url('admin_test/fr') :  url('admin_test/ar') }}" method="POST">
			...
			<input type="submit" class="form-control btn btn-primary " value="{{ __('admin.connexion') }}" name="sub" ><br><br>
	    </form>
	</div>

    <div class="" style="background-color: #19283f;color:#fff;">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top" style="background-color: #19283f;color:#fff;">
