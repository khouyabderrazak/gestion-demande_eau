...
<div  style="min-height:90vh !important;">
	<form class="container" method="POST" action="{{ url('save') }}" enctype="multipart/form-data" style="max-width:55rem;margin:auto;">
		@csrf
        <div id="aaa1">
		<div class="form-row">
		...
		<div class="col-md-12 mb-3 mt-5" >
          ...
          <label class="mb-3 mt-3 l11 text-center" style="color: #fff;background-color:red;border-radius:6px;padding:px;display:none;">Merci D'ecrire le nom correctement</label>
		   <input type="text" class="form-control in1" placeholder="{{ __('service.depose.Noma') }}" name="nom" required>
		</div>
    ...
    <div class="col-md-12 mb-3 " >
		  ...
		  <input type="text" class="form-control in2"  placeholder="{{ __('service.depose.prenoma') }}" name="prenom" required>
		</div>
		<div class="col-md-12 mb-3  ">
		  ...
		  <div class="input-group">
		    <input type="text" class="form-control in3"  placeholder="UB524222" name="cin" aria-describedby="inputGroupPrepend3" required>
		  </div>
		</div>
		<div class="col-md-12 mb-3">
    ...
    <div id="aaa2">
        <div class="form-row">
            <div class="col-md-12 mb-3 mt-5" >
              ...
              <input type="text" class="form-control in7" placeholder="{{ __('service.depose.70') }}" name="nom_batimant" required>
            </div>
            <div class="col-md-12 mb-3 " >
              ...
              <input type="text" class="form-control in8"  placeholder="{{ __('service.depose.70') }}" name="daaira" required>
            </div>
            <div class="col-md-12 mb-3 ">
              ...
              <div class="input-group">
                <input type="text" class="form-control in9"  placeholder="{{ __('service.depose.70') }}" name="province" aria-describedby="inputGroupPrepend3" required>
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              ...
              <div class="input-group">
                <input type="text" class="form-control in10"  placeholder="{{ __('service.depose.70') }}" name="douar" aria-describedby="inputGroupPrepend3" required>
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              ...
              <div class="input-group">
                <input type="text" class="form-control in11"  placeholder="{{ __('service.depose.70') }}" name="commune" aria-describedby="inputGroupPrepend3" required>
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              ...
              <div class="input-group">
                <input type="text" class="form-control in12"  placeholder="{{ __('service.depose.70') }}" name="qiyada" aria-describedby="inputGroupPrepend3" required>
              </div>
            </div>
            </div>
    ...
    <div id="aaa3">
        <div class="form-row">
            <div class="col-md-12 mb-3 ">
              ...
              <div class="input-group">
                <input type="text" class="form-control "  placeholder="X/Y" name="localisationPointDeau" aria-describedby="inputGroupPrepend3" >
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              <label class="mb-3 mt-3">{{ __('service.depose.22') }}</label>
              <div class="input-group">
                <input type="number" class="form-control "  placeholder="0" name="profendeur" aria-describedby="inputGroupPrepend3" >
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              <label class="mb-3 mt-3">{{ __('service.depose.23') }}</label>
              <div class="input-group">
                <input type="number" class="form-control "  placeholder="0" name="debit" aria-describedby="inputGroupPrepend3">
              </div>
            </div>
            <div class="col-md-12 mb-3 ">
              <label class="mb-3 mt-3">{{ __('service.depose.24') }}</label>
              <div class="input-group">
                <input type="number" class="form-control "  placeholder="0" name="plan_Deau" aria-describedby="inputGroupPrepend3">
              </div>
            </div>
            </div>
